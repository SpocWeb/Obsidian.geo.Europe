...
columns:
  ...
  Country:
    ...
    options:
      ...
      - { label: "Austria", backgroundColor: "hsl(64, 95%, 90%)"}
      - { label: "Belarus", backgroundColor: "hsl(265, 95%, 90%)"}
      - { label: "Belgium", backgroundColor: "hsl(22, 95%, 90%)"}
      - { label: "Bosnia_and_Herzegovina", backgroundColor: "hsl(308, 95%, 90%)"}
      - { label: "Bulgaria", backgroundColor: "hsl(82, 95%, 90%)"}
      - { label: "Croatia", backgroundColor: "hsl(75, 95%, 90%)"}
      - { label: "Cyprus", backgroundColor: "hsl(17, 95%, 90%)"}
      - { label: "Czech_Rep.", backgroundColor: "hsl(241, 95%, 90%)"}
      - { label: "Yugoslavia", backgroundColor: "hsl(351, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
